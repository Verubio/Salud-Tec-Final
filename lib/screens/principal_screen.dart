...
<<<<<<< HEAD
    {'nombre': 'Alegre', 'gif': 'assets/carita_riendo.gif', 'frase': '¡Eres el claro ejemplo de que la felicidad es una elección!'},
    {'nombre': 'Feliz', 'gif': 'assets/carita_feliz.gif', 'frase': 'Qué felicidad verte brillar así'},
    {'nombre': 'Estable', 'gif': 'assets/carita_neutra.gif', 'frase': 'Me da mucha paz verte así, en calma'},
    {'nombre': 'Estresado', 'gif': 'assets/carita_enojada.gif', 'frase': 'No tienes que dar explicaciones, pero si quieres hablar, te prometo que te escucho.'},
    {'nombre': 'Crisis', 'gif': 'assets/carita_triste.gif', 'frase': 'No estás solo/a en esto, cuenta conmigo'},
  ];
                  ...
                  children: [
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
<<<<<<< HEAD
                          Text("¿Necesitas hablar?", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF2C5F78))),
                          Text("Un psicólogo está listo para escucharte", style: TextStyle(fontSize: 12, color: Colors.grey)),
=======
                          Text(
                            "¿Necesitas hablar?",
                            style: TextStyle(
...
<<<<<<< HEAD
            ...
            // NUEVO: BOTÓN DE CHATBOT (IA)
            GestureDetector(
              onTap: () => Navigator.pushNamed(context, '/chatbot'), // IMPORTANTE: Define esta ruta en main.dart
              child: Container(
                padding: const EdgeInsets.all(15),
                decoration: BoxDecoration(
                  color: const Color(0xFF2C5F78), // Azul oscuro para contrastar
                  borderRadius: BorderRadius.circular(25),
                  boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.1), blurRadius: 8, offset: const Offset(0, 4))],
                ),
                child: const Row(
                  children: [
                    Icon(Icons.smart_toy_outlined, color: Colors.white, size: 45),
                    SizedBox(width: 15),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
              ...
              child: Container(
                ...
                child: const Row(
                  ...
                  children: [
                    Icon(Icons.menu_book, color: Colors.white, size: 28), 
                    SizedBox(width: 12),
                    Text('Biblioteca de Recursos', style: TextStyle(fontWeight: FontWeight.w600, color: Colors.white, fontSize: 16)),
                  ],
                ),
              ),
            ),
